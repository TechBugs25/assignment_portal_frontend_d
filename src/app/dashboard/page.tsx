...
export default function DashboardPage() {
    return (
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
            ...
            <div className="order-2 xl:order-1 xl:col-span-9 space-y-6">
            ...
            <div className="order-1 xl:order-2 xl:col-span-3 bg-card border border-border rounded-xl p-6 flex flex-col h-fit">
